...
--
-- Хост: localhost
-- Время создания: Окт 31 2012 г., 06:20
...
--
-- Дамп данных таблицы `jos_associations`
--
...
--
-- Дамп данных таблицы `jos_banner_tracks`
--
...
(412, 'plg_editors_tinymce', 'plugin', 'tinymce', 'editors', 0, 1, 1, 1, '{"legacy":false,"name":"plg_editors_tinymce","type":"plugin","creationDate":"2005-2012","author":"Moxiecode Systems AB","copyright":"Moxiecode Systems AB","authorEmail":"N\\/A","authorUrl":"tinymce.moxiecode.com\\/","version":"3.5.2","description":"PLG_TINY_XML_DESCRIPTION","group":""}', '{"mode":"1","skin":"0","entity_encoding":"raw","lang_mode":"1","lang_code":"en","text_direction":"ltr","content_css":"1","content_css_custom":"","relative_urls":"1","newlines":"0","invalid_elements":"script,applet,iframe","extended_elements":"","toolbar":"top","toolbar_align":"left","html_height":"550","html_width":"750","resizing":"true","resize_horizontal":"false","element_path":"1","fonts":"1","paste":"1","searchreplace":"1","insertdate":"1","format_date":"%Y-%m-%d","inserttime":"1","format_time":"%H:%M:%S","colors":"1","table":"1","smilies":"1","media":"1","hr":"1","directionality":"1","fullscreen":"1","style":"1","layer":"1","xhtmlxtras":"1","visualchars":"1","nonbreaking":"1","template":"1","blockquote":"1","wordcount":"1","advimage":"1","advlink":"1","advlist":"1","autosave":"1","contextmenu":"1","inlinepopups":"1","custom_plugin":"","custom_button":""}', '', '', 0, '0000-00-00 00:00:00', 3, 0),
...
(600, 'English (United Kingdom)', 'language', 'en-GB', '', 0, 1, 1, 0, '{"legacy":false,"name":"English (United Kingdom)","type":"language","creationDate":"2008-03-15","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2012 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.5","description":"en-GB site language","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(601, 'English (United Kingdom)', 'language', 'en-GB', '', 1, 1, 1, 0, '{"legacy":false,"name":"English (United Kingdom)","type":"language","creationDate":"2008-03-15","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2012 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.5","description":"en-GB administrator language","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Дамп данных таблицы `jos_finder_filters`
--
...
--
-- Дамп данных таблицы `jos_finder_links`
--
...
--
-- Дамп данных таблицы `jos_finder_links_terms0`
--
...
--
-- Дамп данных таблицы `jos_finder_links_terms1`
--
...
--
-- Дамп данных таблицы `jos_finder_links_terms2`
--
...
--
-- Дамп данных таблицы `jos_finder_links_terms3`
--
...
--
-- Дамп данных таблицы `jos_finder_links_terms4`
--
...
--
-- Дамп данных таблицы `jos_finder_links_terms5`
--
...
--
-- Дамп данных таблицы `jos_finder_links_terms6`
--
...
--
-- Дамп данных таблицы `jos_finder_links_terms7`
--
...
--
-- Дамп данных таблицы `jos_finder_links_terms8`
--
...
--
-- Дамп данных таблицы `jos_finder_links_terms9`
--
...
--
-- Дамп данных таблицы `jos_finder_links_termsa`
--
...
--
-- Дамп данных таблицы `jos_finder_links_termsb`
--
...
--
-- Дамп данных таблицы `jos_finder_links_termsc`
--
...
--
-- Дамп данных таблицы `jos_finder_links_termsd`
--
...
--
-- Дамп данных таблицы `jos_finder_links_termse`
--
...
--
-- Дамп данных таблицы `jos_finder_links_termsf`
--
...
--
-- Дамп данных таблицы `jos_finder_taxonomy_map`
--
...
--
-- Дамп данных таблицы `jos_finder_terms`
--
...
--
-- Дамп данных таблицы `jos_finder_tokens`
--
...
--
-- Дамп данных таблицы `jos_finder_tokens_aggregate`
--
...
--
-- Дамп данных таблицы `jos_finder_types`
--
...
(102, 'main', 'JCE', 'jce', '', 'jce', 'index.php?option=com_jce', 'component', 0, 1, 1, 10000, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/logo.png', 0, '', 43, 52, 0, '', 1),
(103, 'main', 'WF_MENU_CPANEL', 'wf-menu-cpanel', '', 'jce/wf-menu-cpanel', 'index.php?option=com_jce', 'component', 0, 102, 2, 10000, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-cpanel.png', 0, '', 44, 45, 0, '', 1),
(104, 'main', 'WF_MENU_CONFIG', 'wf-menu-config', '', 'jce/wf-menu-config', 'index.php?option=com_jce&view=config', 'component', 0, 102, 2, 10000, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-config.png', 0, '', 46, 47, 0, '', 1),
(105, 'main', 'WF_MENU_PROFILES', 'wf-menu-profiles', '', 'jce/wf-menu-profiles', 'index.php?option=com_jce&view=profiles', 'component', 0, 102, 2, 10000, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-profiles.png', 0, '', 48, 49, 0, '', 1),
(106, 'main', 'WF_MENU_INSTALL', 'wf-menu-install', '', 'jce/wf-menu-install', 'index.php?option=com_jce&view=installer', 'component', 0, 102, 2, 10000, 0, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_jce/media/img/menu/jce-install.png', 0, '', 50, 51, 0, '', 1);
...
--
-- Дамп данных таблицы `jos_overrider`
--
...
('qsis1khggp8f03k106de13p7v5', 0, 1, '1351664404', '__default|a:8:{s:15:"session.counter";i:2;s:19:"session.timer.start";i:1351664116;s:18:"session.timer.last";i:1351664116;s:17:"session.timer.now";i:1351664404;s:22:"session.client.browser";s:105:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/536.9 (KHTML, like Gecko) Chrome/20.0.1115.1 Safari/536.9";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"2923ec3f3a70cdc46ba6b737bac18afc";}', 0, '', '');
...
(4, 'beez_20', 0, '1', 'Beez2 - По умолчанию', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
...
--
-- Дамп данных таблицы `jos_update_categories`
--
...
(3, 'JCE Editor Updates', 'extension', 'https://www.joomlacontenteditor.net/index.php?option=com_updates&view=update&format=xml&id=1', 1, 1332081136);
...
(42, 'Super User', 'admin', 'cats_visit@mail.ru', '2975bbc495715a4118d646eab67a2660:HJHOg6av2tkMTgmgGPENdjx9vxpciH2Q', 'deprecated', 0, 1, '2012-10-31 06:15:11', '0000-00-00 00:00:00', '0', '');
...
--
-- Дамп данных таблицы `jos_user_notes`
--
...
--
-- Дамп данных таблицы `jos_user_profiles`
--
...
--
-- Структура таблицы `jos_wf_profiles`
--
...
--
-- Дамп данных таблицы `jos_wf_profiles`
--
